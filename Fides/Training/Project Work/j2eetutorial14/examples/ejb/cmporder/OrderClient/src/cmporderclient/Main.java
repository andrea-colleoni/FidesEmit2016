...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            Object objref = initial.lookup("ejb/RequestBean");
            RequestRemoteHome home =
                    (RequestRemoteHome) PortableRemoteObject.narrow(objref,
                    RequestRemoteHome.class);
            
            RequestRemote request = home.create();
    ...
    private static void createData(RequestRemote request) {
        try {
    ...
    private static void printData(RequestRemote request) {
        try {
    ...
    private static void printCostOfOrders(RequestRemote request)
